...
function _getInitHtml(themesPath, bodyClass, cssPath, cssData) {
	var arr = [
		...
		/*更改body字体*/
		'body, td {font:3mm "sans serif",tahoma,verdana,helvetica;}',
...
KEditor.prototype = {
	...
	resize : function(width, height, updateProp) {
		...
		// console.log($(this.srcElement).parents('.page'),$(this))
		/*更改*/
		if($(this.srcElement).parents('.page').prev('.page').length>0){
			$(this.srcElement).parents('.page').prev('.page').trigger('mod_ele.sheet');
		}else{
			$(this.srcElement).parents('.page').trigger('mod_ele.sheet')
		}
		// console.log('resize')
		return self;
	},
